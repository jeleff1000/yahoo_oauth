...
class CombinedMatchupStatsViewer:
    ...
    def display(self, prefix):
        ...
        numeric_cols = ['points', 'win', 'loss', 'playoff_wins', 'playoff_losses', 'championships',
                       'ppg_all_time', 'fantasy_games', 'games_started', 'weeks_rostered', 'weeks_on_bench', 'weeks_on_ir',
                       'optimal_player', 'league_wide_optimal_player']
        ...
        for col in ['Wins', 'Losses', 'Playoff Wins', 'Playoff Losses', 'Championships', 'Started', 'Rostered', 'On Bench', 'On IR', 'Optimal', 'League Optimal']:
            if col in df.columns:
        ...
        display_cols = ['Player', 'Pts', 'PPG', 'Pos', 'Started', 'Rostered', 'On Bench', 'On IR',
