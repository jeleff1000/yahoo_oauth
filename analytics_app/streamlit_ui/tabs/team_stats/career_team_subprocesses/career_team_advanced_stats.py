...
def get_advanced_stats(team_data: pd.DataFrame, position: str = "All") -> pd.DataFrame:
    """
    Return advanced stats for career team view.
    Shows aggregated advanced stats for each manager's position group across all years.
    """
    ...
    numeric_columns = [
        "total_points", "spar", "player_spar", "manager_spar",
        ...
        "rushing_yards", "rush_att", "rushing_tds", "rushing_fumbles", "fum_lost",
    ...
    for pos in df['Position'].unique():
        ...
        if pos == 'QB':
            columns = [
                'Manager','Position','Points','SPAR','Player SPAR','Manager SPAR',
            ...
            columns = ['Manager','Position','Points','SPAR','Player SPAR','Manager SPAR']
