...
def get_basic_stats(team_data: pd.DataFrame, position: str = "All") -> pd.DataFrame:
    ...
    numeric_cols = [
        'year', 'points', 'player_spar', 'season_ppg', 'passing_yards', 'passing_tds', 'passing_interceptions',
        'rushing_yards', 'rushing_tds', 'receptions', 'receiving_yards', 'receiving_tds',
        'targets', 'fg_att', 'fg_made', 'pat_made', 'pat_att', 'def_sacks',
        'def_interceptions', 'pts_allow', 'def_td', 'attempts', 'completions', 'rush_att', 'fum_lost',
        'games_played'
    ]
    ...
    # Columns by position
    if position == "QB":
        columns = ["Manager","Position","Year","Points","SPAR","PPG",
