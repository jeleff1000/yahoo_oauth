...
EMPTY_FILTER_RESULT_MESSAGE = (
    "No matchups found with the selected filters. Try adjusting your filter criteria."
)
...
VIEW_DESCRIPTIONS = {
    "weekly": {
        ...
        "features": {
            MATCHUP_TABS[
                "matchup_stats"
            ]: "See basic weekly results, scores, and win/loss outcomes",
            MATCHUP_TABS[
                "advanced_stats"
            ]: "Dive into margins, medians, streaks, grades, and analytics",
            MATCHUP_TABS[
                "projected_stats"
            ]: "Compare actual vs. projected points and accuracy",
            MATCHUP_TABS[
                "team_ratings"
            ]: "View power ratings, playoff odds, and team metrics",
            MATCHUP_TABS[
                "optimal_lineups"
            ]: "See points left on bench and optimal outcomes",
    ...
    "season": {
        ...
        "features": {
            MATCHUP_TABS[
                "matchup_stats"
            ]: "See season-long results, scores, and win/loss outcomes",
            MATCHUP_TABS[
                "advanced_stats"
            ]: "Dive into margins, medians, streaks, grades, and analytics",
            MATCHUP_TABS[
            ...
            MATCHUP_TABS[
                "head_to_head"
            ]: "Compare your season record against each opponent",
        },
    },
    "career": {
        ...
        "features": {
            MATCHUP_TABS[
                "matchup_stats"
            ]: "See all-time results, scores, and win/loss outcomes",
            MATCHUP_TABS[
                "advanced_stats"
            ]: "Dive into career margins, medians, streaks, grades, and analytics",
            MATCHUP_TABS[
                "projected_stats"
            ]: "Compare actual vs. projected points across all seasons",
            MATCHUP_TABS[
                "optimal_lineups"
            ]: "See cumulative points left on bench and optimal outcomes",
            MATCHUP_TABS["team_ratings"]: "View career power ratings and metrics",
            MATCHUP_TABS[
                "head_to_head"
            ]: "Compare your all-time record against each opponent",
        },
    },
}
