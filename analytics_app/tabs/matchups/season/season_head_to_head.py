...
class SeasonHeadToHeadViewer:
    ...
    def display_record(self):
        ...
        st.caption(
            "💡 **How to read:** Rows show each manager's record against opponents (columns). Green cells indicate winning records, red indicates losing records."
        )
    ...
    def display_win_percentage(self):
        ...
        st.caption(
            "💡 **How to read:** Percentage of seasons won by row manager against column opponent. Higher is better."
        )
    ...
    def display_total_points(self):
        ...
        st.caption(
            "💡 **How to read:** Total points scored by row manager in all seasons against column opponent."
        )
    ...
    def display_per_game(self):
        ...
        st.caption(
            "💡 **How to read:** Average points per season scored by row manager against column opponent."
        )
    ...
    def display_avg_margin(self):
        ...
        html = self._style_table(
            avg_margin_table, "Avg Margin Per Season", is_margin=True
        )
        st.markdown(html, unsafe_allow_html=True)

        st.caption(
            "💡 **How to read:** Average point differential per season for row manager vs column opponent."
        )
    ...
    def display_highest_score(self):
        ...
        st.caption(
            "💡 **How to read:** Highest single-season score by row manager against column opponent."
        )
    ...
    def display_lowest_score(self):
        ...
        st.caption(
            "💡 **How to read:** Lowest single-season score by row manager against column opponent."
        )
    ...
    def display_most_recent(self):
        ...
        st.caption(
            "💡 **How to read:** Most recent season result for row manager vs column opponent. Format: W/L (score)."
        )
    ...
    def display_streak(self):
        ...
        st.caption(
            "💡 **How to read:** Current streak for row manager vs column opponent. W3 = 3-season win streak, L2 = 2-season losing streak."
        )
