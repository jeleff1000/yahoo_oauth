...
RESULT_FLAVOR = [
    ...
    # ===================
    {
        "condition": lambda r: _safe_get(r, "is_playoffs") == 1
        and _is_win(r)
        and _margin(r) < 1,
    ...
    # ===================
    {
        "condition": lambda r: _safe_get(r, "is_consolation") == 1
        and _is_win(r)
        and _margin(r) >= 20,
    ...
    # ===================
    {
        "condition": lambda r: _to_int(_safe_get(r, "week"), 0) == 1
        and _is_win(r)
        and _margin(r) >= 20,
    ...
    # ===================
    {
        ...
        and _to_float(_safe_get(r, "team_points"), 0) >= 180,
        "text": "180+ points?! That's a video game score!",
        "category": "result_flavor",
    },
    {
        "condition": lambda r: _is_win(r)
        and _to_float(_safe_get(r, "team_points"), 0) >= 160,
        "text": "160+ points! Your team went OFF!",
        "category": "result_flavor",
    },
    {
        "condition": lambda r: _is_win(r)
        and _to_float(_safe_get(r, "team_points"), 0) >= 150,
    ...
    },
    {
        ...
        and _to_float(_safe_get(r, "team_points"), 0) >= 150
        and _to_float(_safe_get(r, "opponent_points"), 0) >= 150,
    ...
    {
        "condition": lambda r: _is_loss(r)
        and _to_float(_safe_get(r, "team_points"), 0) < 80,
        "text": "Under 80 points? Did your team even show up?",
        "category": "result_flavor",
    },
    {
        "condition": lambda r: _is_loss(r)
        and _to_float(_safe_get(r, "team_points"), 0) < 90,
        "text": "Under 90 points. Rough week all around.",
        "category": "result_flavor",
    },
    {
        "condition": lambda r: _is_win(r)
        and _to_float(_safe_get(r, "team_points"), 0) < 100
        and _to_float(_safe_get(r, "opponent_points"), 0) < 100,
...
LEAGUE_CONTEXT = [
    ...
    {
        "condition": lambda r: _is_win(r)
        and _safe_get(r, "above_league_median") == 0
        and _teams_beat(r) == 0,
    ...
    {
        "condition": lambda r: _is_loss(r)
        and _safe_get(r, "above_league_median") == 1
        and _teams_beat(r) >= 8,
...
PROJECTION_CONTEXT = [
    ...
    {
        "condition": lambda r: _is_win(r)
        and _safe_get(r, "above_proj_score") == 1
        and _safe_get(r, "proj_wins") == 1
        and _safe_get(r, "win_vs_spread") == 1
        and _margin(r) >= 20,
    ...
    # ===================
    {
        ...
        and _safe_get(r, "above_proj_score") == 1
        and _safe_get(r, "proj_wins") == 1
        and _safe_get(r, "win_vs_spread") == 0,
    ...
    {
        "condition": lambda r: _is_win(r)
        and _safe_get(r, "proj_wins") == 0
        and _safe_get(r, "above_proj_score") == 1
        and _to_float(_safe_get(r, "expected_odds"), 50) < 30,
    ...
    # ===================
    {
        "condition": lambda r: _is_win(r)
        and _safe_get(r, "proj_wins") == 0
        and _safe_get(r, "above_proj_score") == 0,
    ...
    # ===================
    {
        ...
        and _safe_get(r, "proj_wins") == 1
        and _safe_get(r, "above_proj_score") == 0
        and _to_float(_safe_get(r, "expected_odds"), 50) > 70,
...
MILESTONE_CONTEXT = [
    ...
    # ===================
    {
        ...
        and _to_int(_safe_get(r, "playoff_seed_to_date"), 99) <= 2,
    ...
    # ===================
    {
        "condition": lambda r: _to_int(_safe_get(r, "wins_to_date"), 0) == 1
        and _is_win(r),
    ...
    {
        "condition": lambda r: _is_win(r)
        and _to_int(_safe_get(r, "wins_to_date"), 0)
        == _to_int(_safe_get(r, "losses_to_date"), -1)
        and _to_int(_safe_get(r, "wins_to_date"), 0) > 1,
    ...
    },
    {
        "condition": lambda r: _is_win(r)
        and _to_int(_safe_get(r, "wins_to_date"), 0)
        == _to_int(_safe_get(r, "losses_to_date"), -1) + 1,
    ...
    {
        "condition": lambda r: _safe_get(r, "team_made_playoffs") == 1
        and _to_int(_safe_get(r, "playoff_seed_to_date"), 99) <= 6,
    ...
    # ===================
    {
        "condition": lambda r: _to_int(_safe_get(r, "week"), 0) >= 11
        and _to_int(_safe_get(r, "playoff_seed_to_date"), 99) <= 2
        and _is_win(r),
    ...
    },
    {
        "condition": lambda r: _to_int(_safe_get(r, "week"), 0) >= 11
        and _to_int(_safe_get(r, "playoff_seed_to_date"), 99) <= 6
        and _safe_get(r, "prev_playoff_seed")
        and _to_int(_safe_get(r, "prev_playoff_seed"), 99) > 6
        and _is_win(r),
    ...
    # ===================
    {
        "condition": lambda r: _to_int(_safe_get(r, "losses_to_date"), 0) == 0
        and _to_int(_safe_get(r, "week"), 0) >= 4
        and _is_win(r),
    ...
    {
        "condition": lambda r: _to_int(_safe_get(r, "wins_to_date"), 0) == 0
        and _to_int(_safe_get(r, "week"), 0) >= 4
        and _is_loss(r),
    ...
    {
        "condition": lambda r: _to_int(_safe_get(r, "losses_to_date"), 0) == 1
        and _is_loss(r)
        and _to_int(_safe_get(r, "week"), 0) >= 5,
...
HISTORICAL_CONTEXT = [
    ...
    # ===================
    {
        "condition": lambda r: _to_int(_safe_get(r, "manager_all_time_ranking"), 0)
        == 1,
    ...
    {
        "condition": lambda r: _to_int(_safe_get(r, "manager_all_time_ranking"), 0) <= 5
        and _to_int(_safe_get(r, "manager_all_time_ranking"), 0) > 0,
    ...
    # ===================
    {
        "condition": lambda r: _to_float(_safe_get(r, "manager_all_time_percentile"), 0)
        >= 99,
    ...
    # ===================
    {
        "condition": lambda r: _to_float(
            _safe_get(r, "manager_all_time_percentile"), 100
        )
        <= 1,
    ...
    {
        "condition": lambda r: _to_int(_safe_get(r, "manager_season_ranking"), 99)
        >= 13,
...
def evaluate_criteria(
    criteria_list: List[Dict], row: Dict, max_per_category: int = 1
) -> List[Dict]:
    """
