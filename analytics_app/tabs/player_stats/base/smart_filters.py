...
class SmartFilterPanel:
    ...
    def display_filters(
        ...
        with st.expander("More ▼", expanded=False):
            ...
            with c2:
                opp_team = st.multiselect(
                    "vs Team",
                    nfl_teams,
                    key=f"{self.key_prefix}_opp",
    ...
    def display_year_slider(self, min_year: int = 1999, max_year: int = None):
        ...
        with c1:
            start = st.number_input(
                ...
                max_value=max_year,
                value=min_year,
                key=f"{self.key_prefix}_start_yr",
            )
        with c2:
            end = st.number_input(
                "To",
