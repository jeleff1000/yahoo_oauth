...
def get_advanced_stats(player_data: pd.DataFrame, position: str = "All") -> pd.DataFrame:
    """
    ...
    numeric_columns = [
        "year", "week", "points", "spar", "player_spar", "manager_spar",
        ...
        "rushing_first_downs", "rushing_epa", "passing_2pt_conversions", "rushing_2pt_conversions",
        "receptions", "receiving_yards", "receiving_tds", "targets", "receiving_fumbles", "receiving_fumbles_lost",
        "receiving_first_downs", "receiving_epa", "target_share", "wopr", "racr",
        "receiving_2pt_conversions", "receiving_air_yards", "receiving_yards_after_catch",
        "air_yards_share", "fg_made", "fg_att", "fg_pct", "fg_long", "fg_made_0_19",
        "fg_made_20_29", "fg_made_30_39", "fg_made_40_49", "fg_made_50_59", "fg_miss",
        "pat_made", "pat_att", "pat_missed", "def_sacks", "def_sack", "def_sack_yards",
        ...
        "def_fumbles_forced", "def_safeties", "def_tds", "def_td", "pts_allow",
        "dst_points_allowed", "points_allowed", "pass_yds_allowed", "passing_yds_allowed",
        "rushing_yds_allowed", "total_yds_allowed", "def_yds_allow", "fumble_recovery_opp",
        "fumble_recovery_tds", "kick_and_punt_ret_td", "3_and_outs", "4_dwn_stops"
    ]
    ...
    renamed_numeric_cols = [
        'Week', 'Points', 'Pass Yds', 'Pass TD', 'Pass Att', 'Comp', 'Air Yds',
        'Pass YAC', 'Pass 1D', 'Pass EPA', 'CPOE', 'PACR', 'Rush Yds', 'Rush Att',
        'Rush TD', 'Rush Fum', 'Rush FL', 'Rush 1D', 'Rush EPA', 'Rec', 'Rec Yds',
        'Rec TD', 'Targets', 'Rec Fum', 'Rec FL', 'Rec 1D', 'Rec EPA', 'Tgt %',
        'WOPR', 'RACR', 'Rec Air Yds', 'Rec YAC', 'Air Yds %', 'FGM', 'FGA', 'FG%',
        'Long', 'FG 0-19', 'FG 20-29', 'FG 30-39', 'FG 40-49', 'FG 50+', 'FG Miss',
        'XPM', 'XPA', 'XP Miss', 'Sacks', 'Sack Yds', 'QB Hits', 'INT', 'INT Yds',
        'PD', 'Solo Tkl', 'Ast Tkl', 'Total Tkl', 'TFL', 'TFL Yds', 'Fum Rec', 'FF',
        'Fum TD', 'Saf', 'Def TD', 'Ret TD', 'PA', 'Total PA', 'Pass Yds Allow',
        'Rush Yds Allow', 'Total Yds Allow', '3&Outs', '4D Stops'
    ]
    ...
    if position == "All":
        core_columns = ["Player","Team","Vs","Week","Year","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot"]
    ...
    for pos in df["Position"].unique():
        ...
        if pos == "QB":
            columns = [
                "Player","Team","Vs","Week","Year","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot",
                "Pass Yds","Pass TD","INT Thrown","Comp","Pass Att","Comp%",
                "Air Yds","Pass YAC","Pass 1D","Pass EPA","CPOE","PACR",
                "Rush Yds","Rush Att","YPC","Rush TD","Rush Fum","Rush FL","Rush 1D","Rush EPA",
                "Pass 2PT","Rush 2PT"
            ]
            ...
            columns = [
                "Player","Team","Vs","Week","Year","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot",
                "Rush Yds","Rush Att","YPC","Rush TD","Rush Fum","Rush FL",
                "Rush 1D","Rush EPA","Rush 2PT",
                "Rec","Rec Yds","YPR","Rec TD","Targets","Catch%",
                "Rec Fum","Rec FL","Rec 1D","Rec EPA","Rec 2PT",
                "Tgt %","WOPR","RACR","Rec Air Yds","Rec YAC","Air Yds %"
            ]
            # Calculate derived stats
            if "Rush Yds" in pos_df.columns and "Rush Att" in pos_df.columns:
                rush_yds = pd.to_numeric(pos_df["Rush Yds"], errors="coerce")
            ...
            columns = [
                "Player","Team","Vs","Week","Year","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot",
                "FGM","FGA","FG%","Long","FG Miss","FG 0-19","FG 20-29","FG 30-39",
                "FG 40-49","FG 50+","XPM","XPA","XP Miss"
            ]

        elif pos == "DEF":
            columns = [
                "Player","Team","Vs","Week","Year","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot",
                "Sacks","Sack Yds","QB Hits","INT","INT Yds","PD",
                "Solo Tkl","Ast Tkl","Total Tkl","TFL","TFL Yds",
                "Def Fum Rec","Fum Rec","FF","Fum TD","Saf","Def TD","Ret TD",
                "PA","Total PA","Pass Yds Allow","Rush Yds Allow","Total Yds Allow",
                "3&Outs","4D Stops"
            ]
        else:
            # For other positions or unknown, show basic columns
            columns = ["Player","Team","Vs","Week","Year","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot"]
