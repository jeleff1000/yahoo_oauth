...
from md.tab_data_access.players import (
    load_career_player_data as load_players_career_data,
)
...
from .career_player_subprocesses.career_player_matchup_stats import (
...
class OptimizedCareerPlayerViewer:
    ...
    def display_sort_options(self, viewer_type: str, active_position: str = None):
        ...
        with col1:
            ...
            sort_col = st.selectbox(
                ...
                available_cols,
                index=(
                    available_cols.index(default_sort_col)
                    if default_sort_col in available_cols
                    else 0
                ),
    ...
    def display(self):
        ...
        # ==================== OPTIMAL LINEUP TAB ====================
        with tabs[3]:
            from .career_player_subprocesses.optimal_lineup_career import (
                OptimalLineupCareerViewer,
            )
        ...
        with st.spinner("Loading advanced career data..."):
            ...
            if career_data is not None and not career_data.empty:
                advanced_stats_df = get_advanced_stats(
                    career_data, active_position or "All"
                )
