...
def apply_modern_styles():
    ...
    @media (max-width: 600px) {
        /* ===== FIX #1: SHRINK TOP NAV BUTTONS (2x2 grid) ===== */
        /* Target buttons inside horizontal blocks */
        ...
        /* Make top nav wrap into 2x2 grid */
        ...
        /* ===== FIX #2: COMPACT FILTERS EXPANDER ===== */
