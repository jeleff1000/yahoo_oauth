...
from .season_team_subprocesses.season_team_basic_stats import (
    get_basic_stats as get_basic_stats_by_pos,
)
from .season_team_subprocesses.season_team_advanced_stats import (
    get_advanced_stats as get_advanced_stats_by_pos,
)
from .season_team_subprocesses.season_team_basic_stats_by_manager import (
        ...
        with st.expander("🔎 Filters", expanded=False):
            ...
            with col1:
                ...
                selected_position = st.selectbox(
                    "Position", positions, index=0, key="season_team_position"
                )
