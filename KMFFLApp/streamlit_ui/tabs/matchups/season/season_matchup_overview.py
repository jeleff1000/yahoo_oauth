...
from ..shared.fun_facts import get_season_fun_facts
...
from .season_head_to_head import SeasonHeadToHeadViewer
...
class SeasonMatchupOverviewViewer:
    ...
    def display(self, prefix=""):
        """Display season matchup data with shared components."""
        # Apply styles
        apply_modern_styles()
        apply_theme_styles()
        ...
        # Generate fun facts
        fun_facts = get_season_fun_facts(self.matchup_df)

        # Render filter UI with data freshness (no weeks for season view)
