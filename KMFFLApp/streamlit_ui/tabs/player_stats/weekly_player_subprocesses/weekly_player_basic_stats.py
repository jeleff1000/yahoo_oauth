...
def get_basic_stats(player_data: pd.DataFrame, position: str) -> pd.DataFrame:
    ...
    numeric_cols = ["year", "week", "points", "spar", "player_spar", "manager_spar",
                    "passing_yards", "passing_tds",
                    "passing_interceptions", "rushing_yards", "rushing_tds",
                    "receptions", "receiving_yards", "receiving_tds", "targets",
                    "fg_att", "fg_made", "pat_made", "pat_att",
                    "def_sacks", "def_interceptions", "pts_allow", "def_tds",
    ...
    if position == "QB":
        columns = ["Player","Team","Vs","Week","Year","Manager","Points","Position",
                   "Pass Yds","Pass TD","Pass INT","Comp","Pass Att","Rush Yds","Rush TD"]
    elif position in ["RB","W/R/T"]:
        columns = ["Player","Team","Vs","Week","Year","Manager","Points","Position",
                   "Rush Yds","Rush TD","Att","Rec","Rec Yds","Rec TD","Tgt"]
    elif position in ["WR","TE"]:
        columns = ["Player","Team","Vs","Week","Year","Manager","Points","Position",
                   "Rec","Rec Yds","Rec TD","Tgt","Rush Yds","Rush TD"]
    elif position == "K":
        columns = ["Player","Team","Vs","Week","Year","Manager","Points","Position",
                   "FGM","FGA","XPM","XPA"]
    elif position == "DEF":
        ...
        columns = ["Player","Team","Vs","Week","Year","Manager","Points","Position","Roster Slot"]
