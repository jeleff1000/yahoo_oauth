...
def get_advanced_stats(player_data, position):
    ...
    if position == "All":
        ...
        core_columns = ["Player","Team","Manager","Points","SPAR","Player SPAR","Manager SPAR","Position","Roster Slot"]
    ...
    numeric_columns = [
        ...
        "pass_yds", "pass_td", "passing_interceptions",
        "attempts", "completions", "passing_air_yards", "passing_yards_after_catch",
        "passing_first_downs", "passing_epa", "passing_cpoe", "pacr",
        "rush_yds", "rush_att", "rush_td", "rushing_fumbles", "rushing_fumbles_lost",
        "rushing_first_downs", "rushing_epa", "rushing_2pt_conversions",
        "rec", "rec_yds", "rec_td", "targets", "receiving_fumbles", "receiving_fumbles_lost",
    ...
    for pos in df['Position'].unique():
        ...
        if pos == 'QB':
            columns = [
                'Player','Team','Manager','Points','SPAR','Player SPAR','Manager SPAR','Position','Roster Slot',
            ...
            columns = ['Player','Team','Manager','Points','SPAR','Player SPAR','Manager SPAR','Position','Roster Slot']
