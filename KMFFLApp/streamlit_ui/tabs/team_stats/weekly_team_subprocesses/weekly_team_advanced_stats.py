...
def get_advanced_stats(team_data: pd.DataFrame, position: str = "All") -> pd.DataFrame:
    """
    Returns weekly advanced team stats partitioned by fantasy_position.
    Shows aggregated advanced stats for each manager's position group.
    """
    ...
    numeric_columns = [
        ...
        "def_fumbles_forced", "def_safeties", "def_tds", "pts_allow",
    ...
    for pos in df['Position'].unique():
        ...
        if pos == 'QB':
            columns = [
                'Manager','Position','Week','Year','Points','SPAR','Player SPAR','Manager SPAR',
            ...
            columns = [
                ...
                'Def Fum Rec','Fum Rec','FF','Fum TD','Saf','Def TD',
                'PA','Total PA','Pass Yds Allow','Rush Yds Allow','Total Yds Allow','3&Outs'
            ]
        else:
            columns = ['Manager','Position','Week','Year','Points','SPAR','Player SPAR','Manager SPAR']
    ...
    if results:
        ...
        sort_cols = [c for c in ['Year', 'Week', 'Points'] if c in result.columns]
        if sort_cols:
            result = result.sort_values(sort_cols, ascending=[False, False, False], na_position="last")
